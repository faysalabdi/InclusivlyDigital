  ...
  return (
    <section className="py-16 md:py-24 bg-primary">
      <div className="container mx-auto px-4 text-center text-white">
        ...
        >
          Ready to Grow Your Healthcare or NDIS Business?
        </motion.h2>
        <motion.p 
        ...
        >
          Take the first step toward a stronger online presence. Contact us today for a complimentary digital marketing assessment.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
